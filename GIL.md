...
Here 3 beacuse :
The empty list object was referenced by a, b and the argument passed to sys.getrefcount().
-----------------------------------------------------------------------------------------
...
Removal of GIL without causing backward incompatibility issues.
...
he problem in this mechanism was that most of the time the CPU-bound thread would reacquire the GIL itself before other threads could acquire it. This was researched by David Beazley and visualizations can be found here.
...
See Image for GIL study by Dave .
